' introscoping.ru Secure WebDisk.vbs
'
...
' *************************************************************************
strURL = "https://introscoping.ru:2078/" ' This is the URL to the WebDAV share.
...
Sub CreateShorty ()
   ...
   strAppname = "introscoping.ru_Secure_WebDisk.vbs" 
   Const NETHOOD = &H13&
   Const MAXIMIZE_WINDOW = 3
   strName = "introscoping.ru Secure WebDisk"
